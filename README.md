# aulaProgramacaoWeb
# 💙 Organização de Voluntários - Single Page Application (SPA)
...
* **Estratégia de Branching:** Utilizamos o modelo **GitFlow**. O desenvolvimento ocorre na branch `develop`, e os novos recursos são criados em branches  dedicadas. A branch `main` é reservada para releases de produção.
